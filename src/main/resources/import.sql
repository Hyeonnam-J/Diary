...
insert into comment (origin, user_id, post_id, content, created_date, last_modified_date, depth) values (1, 1, 1, 'comment-content111', now(), now(), 0);
insert into comment (origin, user_id, post_id, content, created_date, last_modified_date, depth) values (2, 2, 1, 'comment-content222', now(), now(), 0);
