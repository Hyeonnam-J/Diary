...
insert into post (title, content, view_count, is_delete, created_date, last_modified_date, user_id, origin, num, depth) values ('title', 'content', 0, false, now(), now(), 1, 1, 0, 0);
insert into comment (user_id, post_id, content, created_date, last_modified_date) values (1, 1, 'comment-content111', now(), now());
insert into comment (user_id, post_id, content, created_date, last_modified_date) values (1, 1, 'comment-content222', now(), now());